...
<template>
  ...
  <div class=" d-flex flex-column flex-md-row justify-content-between justify-content-md-around align-items-center">
    ...
    <div class="dropdown">
      ...
      <ul class="dropdown-menu">
        <li>
          <p @click="setFilterTag('MongoDB')" class="dropdown-item selectable">MongoDB</p>
        </li>
        <li>
          <p @click="setFilterTag('MySQL')" class="dropdown-item selectable">MySQL</p>
        </li>
      </ul>
    </div>
